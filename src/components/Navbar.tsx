...
export function Navbar() {
  ...
  useEffect(() => {
    if (xRef.current) {
      xRef.current.href = "https://x.com/0xdirectping\x5F";
    }
  }, []);
    ...
    <nav className="sticky top-0 z-50 border-b-2 border-border bg-background">
      <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-5">
          ...
          <a ref={xRef} href="#" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-foreground transition-colors">
